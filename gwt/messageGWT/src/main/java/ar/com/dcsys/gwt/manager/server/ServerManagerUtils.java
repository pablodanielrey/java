...
public class ServerManagerUtils {
	...
	private static final Logger logger = Logger.getLogger(ServerManagerUtils.class.getName());
	...
	public static List<String> decodeParams(String params) {
		...
		for (String p : par) {
			logger.fine("Decodificando parámetro : " + p);
			String decoded = "";
	...
	@Inject
	public ServerManagerUtils(ManagerFactory managerFactory) {
