...
@Singleton
public class RemoveJustificationDateMethodHandler extends AbstractMessageHandler {

	private static final Logger logger = Logger.getLogger(RemoveJustificationDateMethodHandler.class.getName());
	...
	@Inject
	public RemoveJustificationDateMethodHandler(AssistanceEncoderDecoder encoderDecoder,
	...
	public boolean handles(Method method) {
		return AssistanceMethods.removeJustificationDate.equals(method.getName());
	}
	...
	public void handle(MessageContext ctx, Message msg, Method method) {
		...
		List<JustificationDate> justifications = encoderDecoder.decodeJustificationDateList(params);
		
		try {
			justificationsModel.remove(justifications);
