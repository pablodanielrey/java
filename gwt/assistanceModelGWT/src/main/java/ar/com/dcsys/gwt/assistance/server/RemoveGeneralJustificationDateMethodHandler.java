...
@Singleton
public class RemoveGeneralJustificationDateMethodHandler extends AbstractMessageHandler {
	...
	@Inject
	public RemoveGeneralJustificationDateMethodHandler(AssistanceEncoderDecoder encoderDecoder,
	...
	public boolean handles(Method method) {
		return AssistanceMethods.removeGeneralJustificationDate.equals(method.getName());
	}
	...
	public void handle(MessageContext ctx, Message msg, Method method) {
		...
		try {
			justificationsModel.removeGeneralJustificationDate(justifications);
