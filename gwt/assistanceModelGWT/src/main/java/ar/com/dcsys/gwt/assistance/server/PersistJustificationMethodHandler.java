...
import ar.com.dcsys.gwt.assistance.client.gin.AssistanceModelGinModule;
...
@Singleton
public class PersistJustificationMethodHandler extends AbstractMessageHandler {
	...
	@Inject
	public PersistJustificationMethodHandler(AssistanceEncoderDecoder encoderDecoder,
	...
	public boolean handles(Method method) {
		return AssistanceMethods.persistJustification.equals(method.getName());
	}	
	...
	public void handle(MessageContext ctx, Message msg, Method method) {
		...
		try {
			justificationsModel.persist(justification);
