 ...
 * 
 */
package ar.com.dcsys.data.person.backend;
...
public class PersonLdapBackEnd implements PersonBackEnd {
	...
	private static final Logger logger = Logger.getLogger(PersonLdapBackEnd.class.getName());
	...
	public PersonLdapBackEnd(DirContextProvider cp) {
		this.cp = cp;
	}
